...
//
//
//  Created by Paul Philip Mitchell on 09/12/2021.
//
...
public class IsoCountries {
    public class func flag(countryCode: String) -> String? {
        // ICAO-specific entities for which we do not have flags
        if countryCode.prefix(1) == "X", countryCode != "XK" {
            return nil
        }
    ...
    static let allCountries: [IsoCountryInfo] = [
        ...
        IsoCountryInfo(name: "Kosovo, Republic of", numeric: "", alpha2: "XK", alpha3: "RKS", calling: "+383", currency: "EUR", continent: "EU"),
        IsoCountryInfo(name: "Kosovo, Republic of", numeric: "", alpha2: "XK", alpha3: "XKX", calling: "+383", currency: "EUR", continent: "EU"),
        ...
        // ICAO Countries
        IsoCountryInfo(name: "Germany", numeric: "991", alpha2: "DE", alpha3: "D<<", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "British Dependent territories citizen", numeric: "992", alpha2: "GB", alpha3: "GBD", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "British National (Overseas)", numeric: "992", alpha2: "GB", alpha3: "GBN", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "British Overseas citizen", numeric: "992", alpha2: "GB", alpha3: "GBO", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "British Protected person", numeric: "992", alpha2: "GB", alpha3: "GBP", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "British Subject", numeric: "992", alpha2: "GB", alpha3: "GBS", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Stateless person", numeric: "992", alpha2: "XX", alpha3: "XXA", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Refugee", numeric: "992", alpha2: "XX", alpha3: "XXB", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Refugee (other)", numeric: "992", alpha2: "XX", alpha3: "XXC", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Unspecified", numeric: "992", alpha2: "XX", alpha3: "XXX", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Europe", numeric: "992", alpha2: "EU", alpha3: "EUE", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "United Nations Organization", numeric: "992", alpha2: "UN", alpha3: "UNO", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "United Nations Agency", numeric: "992", alpha2: "UN", alpha3: "UNA", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "United Nations Interim Administration Mission in Kosovo", numeric: "992", alpha2: "UN", alpha3: "UNK", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "African Development Bank (ADB)", numeric: "992", alpha2: "XX", alpha3: "XBA", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "African Export-Import Bank (AFREXIM bank)", numeric: "992", alpha2: "XX", alpha3: "XIM", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Carribean community or one of its emissaries (CARICOM)", numeric: "992", alpha2: "XC", alpha3: "XCC", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Common Market for Eastern and Southern Africa (COMESA)", numeric: "992", alpha2: "XX", alpha3: "XCO", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Economic Community of West African States (ECOWAS)", numeric: "992", alpha2: "XX", alpha3: "XEC", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "International Criminal Police Organization (INTERPOL)", numeric: "992", alpha2: "XP", alpha3: "XPO", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Sovereign Military Order of Malta or one of its emissaries", numeric: "992", alpha2: "XO", alpha3: "XOM", calling: "+999", currency: "XXX", continent: "XXX"),
        IsoCountryInfo(name: "Utopia", numeric: "993", alpha2: "XUT", alpha3: "UTO", calling: "+999", currency: "XXX", continent: "XXX"),
    ]
}
